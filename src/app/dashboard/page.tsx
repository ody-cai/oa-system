...
export default function DashboardPage() {
  ...
  return (
    <div className="p-8">
      {/* 欢迎区域 */}
      <div className="mb-8">
        <h1 className="text-3xl font-semibold text-[#2D3748]">
          欢迎回来！
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <Card className="border-0 shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <FileText className="h-5 w-5 text-[#ED8936]" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-[#2D3748]">{fileStat.total_files}</div>
        ...
        <Card className="border-0 shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <TrendingUp className="h-5 w-5 text-[#48BB78]" />
          </CardHeader>
          <CardContent>
        ...
        <Card className="border-0 shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <MessageSquare className="h-5 w-5 text-[#ECC94B]" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-[#2D3748]">{announcements.length}</div>
        ...
        <Card className="border-0 shadow-sm">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <Calendar className="h-5 w-5 text-[#ED8936]" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-[#2D3748]">0</div>
      ...
      {/* 快捷操作 */}
      <div className="mb-8">
        <h2 className="text-lg font-semibold text-[#2D3748] mb-4">快捷操作</h2>
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold text-[#2D3748]">最新公告</h2>
          <Button variant="ghost" size="sm" className="text-[#ED8936]">
            查看全部
          </Button>
        </div>
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        {announcement.is_pinned && (
                          <Bell className="h-4 w-4 text-[#ED8936]" />
                        )}
                      </div>
